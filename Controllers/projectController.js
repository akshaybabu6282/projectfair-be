...
exports.getAllProject = async (req, res) => {
    ...
    const searchQuery = {
        /* language:{
            $regex:searchKey,$options:'i'  // 'i' is used to remove case sensitivity
        } */
        $or: [
            {
                language: {
                    $regex: searchKey,
                    $options: 'i'   // 'i' is used to remove case sensitivity
                }
            },
            {
                title: {
...
//3) get all project uploaded by that specific user
